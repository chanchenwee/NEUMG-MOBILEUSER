			...
			<div class="input_wrapper">
				<div class="inputItem" :class="{'focus':isFocus.password1,'password_error':errorFlag.password1}">
					<div class="inputContent">
						...
						<input type="password" @focus="focus('password1')" @blur="blur('password1')" ref="password1" placeholder="请输入新密码"
						 v-model="input_info.password1">
					</div>
				</div>
				<div class="inputItem" :class="{'focus':isFocus.password2,'password_error':errorFlag.password2,'password_dif':errorFlag.password2_dif}">
					<div class="inputContent">
						...
						<input type="password" @focus="focus('password2')" @blur="blur('password2')" ref="password2" placeholder="再次输入新密码"
						 v-model="input_info.password2" @keyup="validatePassword()">
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			//点击完成
			clickFinish() {
				if (this.input_info.password1 != "" && this.input_info.password2 != "") {
					if (this.input_info.password1 == this.input_info.password2) {
						this.axios.get(`${server}${updatepassword}`, {
							params: {
								phone: this.$route.query.phone,
								password: this.input_info.password1,
							}
						}).then((res) => {
